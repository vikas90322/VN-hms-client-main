...
const AllAppointments = () => {
  ...
  const [, setCurrentDateTime] = useState(new Date()); // Initialize with the current date and time
          ...
          {!selectedAppointment && (
            <div className="appoinments-empid143">
              <div className="Total-Appointments-empid143">
                <h4> Appointments ({totalAppointmentsCount})</h4>
                {docstaffid}
                {/* Search bar */}
              </div>
                  ...
                  (data) =>
                    ...
                    docstaffid === data.staffid && (
                      <tr key={data.id} className="appointment123">
                        <td className="empid143b1">{data.patientId.toUpperCase()}</td>
